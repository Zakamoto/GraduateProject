...
<center><div id="chart_rice" style="width:1400px;"></div></center>
...
<script type="text/javascript">
        ...
        Highcharts.chart('chart_rice', {
          ...
          },
          {
              ...
              data: [
                      <?php for($i=0;$i<25;$i++){ ?>
                        <?= get_history_rice($data[$i][0]['Name'],2557); ?>,
                      <?php } ?>
                    ],
              marker: {
                  lineWidth: 2,
          ...
          },
          {
              ...
              data: [
                      <?php for($i=0;$i<25;$i++){ ?>
                        <?= get_history_rice($data[$i][0]['Name'],2558); ?>,
                      <?php } ?>
                    ],
              marker: {
                  lineWidth: 2,
          ...
          },
          {
              ...
              data: [
                      <?php for($i=0;$i<25;$i++){ ?>
                        <?= get_history_rice($data[$i][0]['Name'],2559); ?>,
                      <?php } ?>
                    ],
              marker: {
                  lineWidth: 2,
